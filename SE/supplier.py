...
class supplierClass:
    def __init__(self, root):
        ...
        btn_search=Button(self.root, text="Search", command=self.search, font=("goudy old style", 15), bg="#4caf50", fg="white", cursor="hand2").place(x=950, y=80, width=100, height=28)
        ...
        emp_frame.place(x=680, y=120, width=370, height=350)
    ...
    def search(self):
        ...
        try:
            if self.var_searchtxt.get()=="":
                messagebox.showerror("Error", "Invoice No. should be rquired", parent=self.root)
            else:
