...
class Login_System:
    def __init__(self, root):
        ...
        lbl_employee_id = Label(login_frame, text="Employee ID", font=("Andalus", 15), bg="white", fg="#767171").place(x=50, y=100)
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    if chk=='f':
                        ...
                        title=Label(self.forget_win, text="Reset Password", font=("goudy old style0", 15, "bold"), bg="#3f51b5", fg="white").pack(side=TOP, fill=X)                    
    ...
    def update_password(self):
        if self.var_new_pass.get()=="" or self.var_conf_pass.get()=="":
            ...
            messagebox.showerror("Error", "Both Password must be same", parent=self.forget_win)
