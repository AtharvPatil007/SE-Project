...
class IMS:
    def __init__(self, root):
        ...
        self.root.title("Inventory Management System | Developed By AP")
        ...
        #=============clock==============
        self.lbl_clock=Label(self.root, text="Welcome to Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS", font=("times new roman", 15), bg="#4d634d", fg="white")
        ...
        #=============footer==============
        lbl_footer=Label(self.root, text="IMS-Inventory Management System | Developed By AP\nFor any Technical Issue Contact: 8329087701", font=("times new roman", 12), bg="#4d634d", fg="white").pack(side=BOTTOM, fill=X)   
