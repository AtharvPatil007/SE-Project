...
class employeeClass:
    def __init__(self, root):
        ...
        #=============options============
        cmb_search=ttk.Combobox(SearchFrame, textvariable=self.var_searchby, values=("Select", "Email", "Name", "ID"), state='readonly', justify=CENTER, font=("goudy old style", 15))                            
...
#========Category Details=========
        ...
        # cat_frame.place(x=700, y=120, width=380, height=350)
        ...
        emp_frame.place(x=0, y=350, width=1100, height=150)
